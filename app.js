...
// Tab click delegation - ensures tabs work even if onclick attrs fail
document.querySelectorAll(’.tab-btn’).forEach(function(btn) {
btn.addEventListener(‘click’, function() {
var tab = btn.id.replace(‘tab-’, ‘’);
...
// Render initial screen - use switchTab to ensure active class + repaint
switchTab(‘home’);
...
var d = document.createElement(‘div’);
d.style.cssText = ‘position:fixed;top:0;left:0;right:0;background:#c00;color:#fff;font-size:12px;padding:12px;z-index:99999;word-break:break-all;font-family:monospace;white-space:pre-wrap’;

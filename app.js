...
var d = document.createElement(‘div’);
d.style.cssText = ‘position:fixed;bottom:0;left:0;right:0;background:#111;color:#f44;font-size:11px;padding:8px;z-index:99999;word-break:break-all;font-family:monospace’;
d.textContent = ‘ERR: ’ + msg + ’ L:’ + line + ’ C:’ + col;
...
// Hide splash - force remove
setTimeout(function() {
var splash = document.getElementById(‘splash’);
if (!splash) return;
// Stop all animations first
splash.style.animation = ‘none’;
var els = splash.querySelectorAll(’*’); for (var ei=0;ei<els.length;ei++){els[ei].style.animation=‘none’;}
